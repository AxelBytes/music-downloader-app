...
async def download_premium_mp3(url: str, quality: str):
    ...
    ydl_opts = {
        ...
        # 💣💣💣 ESTRATEGIA DE APP DE YOUTUBE REAL 💣💣💣
        # 🔥🔥🔥 HEADERS DE LA APP REAL DE YOUTUBE 🔥🔥🔥
        'http_headers': {
            ...
            'X-YouTube-Device-Model': 'SM-G973F',
            'X-YouTube-OS-Version': '11',
            'X-YouTube-Platform': 'ANDROID',
            'X-YouTube-User-Agent': 'com.google.android.youtube/19.09.37 (Linux; U; Android 11) gzip',
            'X-Goog-Visitor-Id': 'CgtwVjBfQjFfQjFfQjE%3D',
            'X-Goog-AuthUser': '0',
            'X-Goog-PageId': 'com.google.android.youtube',
            'X-Goog-Encode-Response-If-Executable': 'base64',
            'X-YouTube-Client-Screen': 'NORMAL',
            'X-YouTube-Client-Screen-Density': '420',
            'X-YouTube-Client-Screen-Resolution': '1080x2400',
            'X-YouTube-Client-Theme': 'DEFAULT_THEME',
            'X-YouTube-Client-FormFactor': 'PHONE',
            'X-YouTube-Client-Connection-Type': 'WIFI',
            'X-YouTube-Client-Language': 'en',
            'X-YouTube-Client-Country': 'US',
            'X-YouTube-Client-Time-Zone': 'America/New_York',
            'X-YouTube-Client-Device-Type': 'PHONE',
            'X-YouTube-Client-Device-Brand': 'samsung',
            'X-YouTube-Client-Device-Model': 'SM-G973F',
            'X-YouTube-Client-OS-Version': '11',
            'X-YouTube-Client-OS-Name': 'Android',
            'X-YouTube-Client-OS-Arch': 'arm64-v8a',
            'X-YouTube-Client-App-Version': '19.09.37',
            'X-YouTube-Client-App-Name': 'youtube',
            'X-YouTube-Client-App-Package': 'com.google.android.youtube',
            'X-YouTube-Client-App-Install-Time': '1640995200',
            'X-YouTube-Client-App-Update-Time': '1640995200',
            'X-YouTube-Client-App-Install-Source': 'GOOGLE_PLAY',
            'X-YouTube-Client-App-Install-Referrer': 'com.android.vending',
            'X-YouTube-Client-App-Install-Campaign': 'organic',
            'X-YouTube-Client-App-Install-Adgroup': 'organic',
            'X-YouTube-Client-App-Install-Creative': 'organic',
            'X-YouTube-Client-App-Install-Keyword': 'organic',
            'X-YouTube-Client-App-Install-Gclid': 'organic',
            'X-YouTube-Client-App-Install-Dclid': 'organic',
