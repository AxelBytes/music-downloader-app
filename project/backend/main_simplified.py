"""
Simplified FastAPI backend for PythonAnywhere
Works without external database connection
"""
...
app = FastAPI(
    title="Music Downloader API - Simplified",
    version="2.0.0"
)
...
async def search(query: str = Query(...)):
    """Search for music - returns mock data"""
    if not query:
    ...
    return {
        ...
        "results": [
            {
                "id": "mock-1",
                "title": f"Resultado de búsqueda: {query}",
                "artist": "Artista Demo",
                "duration": 240,
