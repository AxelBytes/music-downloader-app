...
export default function PremiumProfileScreen() {
  ...
  const handleForceClean = async () => {
    console.log('🔐 [Profile] Forzando limpieza completa...');
    try {
      // Limpiar AsyncStorage manualmente
      ...
      if (AsyncStorage) {
        ...
        if (supabaseKeys.length > 0) {
          ...
          console.log('🔐 [Profile] Keys limpiadas:', supabaseKeys);
        }
      }
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Animated.View entering={FadeInDown} style={styles.header}>
            <View style={styles.headerContent}>
              <Text style={styles.headerTitle}>Perfil DEBUG</Text>
          ...
          {/* Botón de limpieza forzada temporal */}
          <Animated.View entering={FadeInDown.delay(1200)} style={styles.signOutSection}>
            <TouchableOpacity
              style={styles.debugButton}
              onPress={handleForceClean}
            >
              <LinearGradient
                colors={['rgba(239, 68, 68, 0.8)', 'rgba(245, 158, 11, 0.8)']}
                style={styles.debugButtonGradient}
              >
                <Text style={styles.debugButtonText}>🧹🧹🧹 LIMPIEZA FORZADA DEBUG 🧹🧹🧹</Text>
              </LinearGradient>
            </TouchableOpacity>
          </Animated.View>
